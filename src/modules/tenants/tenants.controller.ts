...
} from './dto/tenant-user-create.dto';
import {
  UpdateTenantUserDto,
  updateTenantUserSchema,
} from './dto/tenant-user-update.dto';
...
export class TenantController {
  ...
  updateTenantUser(
    ...
    @Body(new CustomValidationPipe(updateTenantUserSchema))
    params: UpdateTenantUserDto,
  ) {
