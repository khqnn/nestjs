...
const authorizeSubject = (options?: {path?: string, query?: string, sub?: string}, claims?: any, request?: any)=>{
...
export class PermissionsGuard implements CanActivate {
    constructor(private permissions: string[] | null, private options?: { path?: string, query?: string, sub?: string, should_owner?: boolean }) { }
